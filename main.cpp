...
int main(int argc, char** argv) {
	IdxGen idxGen; // TODO: Implement IdxGen
	system("cls");

	// Wont use this for long term
	int user_index = 0;
	int email_index = 0;
	...
	/// TESTS
	{
		User user_one(user_index++, "John", "j1@example.com");
		User user_two(user_index++, "Jane", "j2@example.com");
